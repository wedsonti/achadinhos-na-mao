...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Rq6hy9h3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var styles_default = "/assets/styles-CnacmoOl.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A gente garimpa. Você aproveita."
			},
			{
				name: "author",
				content: "AT promo"
...
var $$splitComponentImporter = () => import("./routes-DTaUX8d1.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "AT promo | Ofertas, cupons e achadinhos" },
		{
			name: "description",
			content: "O AT promo garimpa ofertas, cupons e achadinhos para você receber oportunidades direto no celular. É grátis."
		},
		{
			property: "og:title",
			content: "AT promo — A gente garimpa. Você aproveita."
		},
		{
			property: "og:description",
